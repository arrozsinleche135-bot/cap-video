...
const credsRaw = readFileSync(`${SCRATCH}/admin_credentials.txt`, 'utf8');
const username = credsRaw.match(/Usuario:\s*(\S+)/)[1];
const password = credsRaw.match(/Contraseña:\s*(\S+)/)[1];
const outFile = `${SCRATCH}/admin_session.json`;
